...
## open the file
parser = argparse.ArgumentParser(description='Deleteriousness Estimation V1.0')
...
fo_aa = open('scaled_aa_info.txt',"r")
...
def deleteriousness_estimation(snv_element):
    ...
    if mut_status == "nonsynonymous":
        ...
        deviance_snv =  sum(abs(substitute_vector - standard_vector))/50
